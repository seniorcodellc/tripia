...
import 'package:tripia_user/features/travelScreens/presentation/widgets/bottom_sheets.dart';
import 'package:tripia_user/features/travelScreens/presentation/widgets/buttons.dart';
...
class _TravelScreenState extends State<TravelScreen> {
  ...
  void _showBottomSheetPlace() {
    showModalBottomSheet(
        ...
        context: context,
        builder: (context) => PlaceBottomSheet(city: city1,address: address,)
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(AppStrings.destination,style: TextStyle(
                        ...
                        MyTextFieldTravel2(controller: controller2,hintText: AppStrings.mansoura, obsecureText: false,suffixicon: Icon(
                          Icons.location_on,
                        ...
                        SizedBox(height: context.height*0.01,),
                         MyTextFieldTravel2(controller: controller2,hintText: AppStrings.ahmedMaher2, obsecureText: false,suffixicon: Icon(
                          Icons.location_on,
                        ),),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SvgPicture.asset(AppAssets.greyRectangle,width: context.width*0.36,),
                        SizedBox(height: context.height*0.016,),
                        Text(AppStrings.notes2,style: TextStyle(
                            fontFamily: FontFamilies.almarai,
                            fontWeight: FontWeight.w700,fontSize: Dimensions.font26/1.2),),
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintStyle: TextStyle(color: AppColors.hintTextFieldColor,fontFamily: FontFamilies.jFlat,fontSize: Dimensions.font20/1.35),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          centerTitle: true,
          title: const Text(AppStrings.travel,style: TextStyle(
                 ...
                 children: [
                   SingleChildScrollView(
                     child: Column(
                       children: [
                         Row(
                           children: [
                             ...
                             Text(AppStrings.meetingPlace,style: TextStyle(
                                 fontWeight: FontWeight.w400,
                                 fontFamily: FontFamilies.jFlat,
                                 color: AppColors.primaryColor,fontSize: Dimensions.font16*1.1),),
                         ...
                         Row(
                           children: [
                             SizedBox(width: context.width*0.75,),
                             Text(AppStrings.destination,style: TextStyle(
                                 fontWeight: FontWeight.w400,
                                 fontFamily: FontFamilies.jFlat,
                         ...
                         Row(
                           children: [
                             SizedBox(width: context.width*0.065,),
                             MyTextFieldTravel(hintText: AppStrings.nasrCityCairo,
                                 obsecureText: false,
                                 suffixicon: Icon(Icons.arrow_back_ios,size: Dimensions.iconSize16*1.25,color: AppColors.locationTextFieldBlackColor,),
                               onTap: (){
                         ...
                         Row(
                           children: [
                             SizedBox(width: context.width*0.69,),
                             Text(AppStrings.noOfPassengers,style: TextStyle(
                                 fontFamily: FontFamilies.jFlat,
                                 fontWeight: FontWeight.w400,
                                 color: AppColors.redBlack,fontSize: Dimensions.font16*1.1),),
                             SizedBox(width: context.width*0.015,),
                             SvgPicture.asset(
                               AppAssets.seat,
                               width: context.width*0.07,
                         ...
                         Row(
                           children: [
                             SizedBox(width: context.width*0.597,),
                             Text(AppStrings.chooseCarType,style: TextStyle(
                                 fontFamily: FontFamilies.jFlat,
                                 fontWeight: FontWeight.w400,
                                 color: AppColors.blackColor2,fontSize: Dimensions.font16*1.1),),
                             SizedBox(width: context.width*0.015,),
                             SvgPicture.asset(
                         ...
                         Row(
                           children: [
                             SizedBox(width: context.width*0.074,),
                             InkWell(
                               onTap:(){
                                 setState(() {
                                   widget.isRed1=true;
                               ...
                               child: Container(
                                 ...
                                 child: Row(
                                   children: [
                                     ...
                                     SizedBox(width: context.width*0.267,),
                                     Column(
                                       children: [
                                         SizedBox(height: context.height*0.025,),
                                         Row(
                   ...
                   Column(
                     children: [
                       ...
                       Row(
                         children: [
                           SizedBox(width: context.width*0.928,),
                           Container(
                   ...
                   Column(
                     children: [
                       ...
                       Row(
                         children: [
                           SizedBox(width: context.width*0.93,),
                           Container(
                               height: context.height*0.11,
                               child: SvgPicture.asset(AppAssets.lineBooking)),
                         ],
                   ...
                   Column(
                     children: [
                       SizedBox(height: context.height*0.28,),
                       Row(
                         children: [
                           SizedBox(width: context.width*0.93,),
                           Container(
               ...
               child: Stack(
                 children: [
                   SingleChildScrollView(
                     child: Column(
                       children: [
                         Row(
                           children: [
                             SizedBox(width: context.width*0.48,),
                             GestureDetector(
                               onTap: (){
                                 setState(() {
                               ...
                               child: Text(AppStrings.readyTrips,
                                 style: TextStyle(
                                     color: widget.newTrip==false?AppColors.textRedColor:AppColors.iconPrefixColor2,
                                     fontWeight: FontWeight.w400,
                                     fontFamily: FontFamilies.jFlat,
                                     fontSize: Dimensions.font16*1.1
                                 ),
                             ...
                             GestureDetector(
                               ...
                               child: Text(AppStrings.newTrips,
                                 style: TextStyle(
                                     color: widget.newTrip==true?AppColors.textRedColor:AppColors.iconPrefixColor2,
                                     fontWeight: FontWeight.w400,
                                     fontFamily: FontFamilies.jFlat,
                                     fontSize: Dimensions.font16*1.1
                                 ),
                         ...
                         if(widget.newTrip==true)
                            Row(
                           children: [
                             SizedBox(width: context.width*0.745,),
                             Container(
                         ...
                         Row(
                           children: [
                             SvgPicture.asset(AppAssets.lineTravel,width: context.width*0.95,),
                           ],
                         ),
                                 ...
                                 InkWell(
                                   ...
                                   child: Container(
                                     ...
                                     decoration: BoxDecoration(
                                       ...
                                       border: Border.all(
                                         color:widget.isRed1==true && widget
                                             .isRed2==false && widget.isRed3==false ? AppColors.primaryColor:AppColors.transparent,
                                       ),
                                       borderRadius: BorderRadius.circular(Dimensions.radius20),
                                       boxShadow: [
                                         const BoxShadow(
                                       ...
                                       children: [
                                         ...
                                         Column(
                                           children: [
                                             SizedBox(height:context.height*0.032 ,),
                                             if(widget.isRed1==true && widget
                                                 .isRed2==false && widget.isRed3==false)
                                               SvgPicture.asset(AppAssets.trueRedSign),
                                           ],
                                         ),
                                         SizedBox(width: context.width*0.267,),
                                 ...
                                 InkWell(
                                   ...
                                   child: Container(
                                     ...
                                     decoration: BoxDecoration(
                                       ...
                                       border: Border.all(
                                         color:widget.isRed1==false && widget
                                             .isRed2==true && widget.isRed3==false? AppColors.primaryColor:AppColors.transparent,
                                       ),
                                       borderRadius: BorderRadius.circular(Dimensions.radius20),
                                       boxShadow: [
                                         const BoxShadow(
                                       ...
                                       children: [
                                         ...
                                         Column(
                                           children: [
                                             SizedBox(height:context.height*0.032 ,),
                                             if(
                                             widget.isRed1==false && widget.isRed2==true && widget.isRed3==false
                                             )
                                               SvgPicture.asset(AppAssets.trueRedSign),
                                 ...
                                 InkWell(
                                   ...
                                   child: Container(
                                     ...
                                     decoration: BoxDecoration(
                                       ...
                                       border: Border.all(
                                         color:widget.isRed1==false && widget
                                             .isRed2==false && widget.isRed3==true? AppColors.primaryColor:AppColors.transparent,
                                       ),
                                       borderRadius: BorderRadius.circular(Dimensions.radius20),
                                       boxShadow: [
                                         const BoxShadow(
                                       ...
                                       children: [
                                         ...
                                         Column(
                                           children: [
                                             SizedBox(height:context.height*0.032 ,),
                                             if(
                                             widget.isRed1==false && widget.isRed2==false && widget.isRed3==true
                                             )
                                               SvgPicture.asset(AppAssets.trueRedSign),
                   ...
                   if(widget.newTrip==true)
                         Column(
                     children: [
                       SizedBox(height: context.height*0.225,),
                       Row(
                         children: [
                           SizedBox(width: context.width*0.93,),
                           Container(
