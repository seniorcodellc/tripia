...
class _BookingScreen1State extends State<BookingScreen1> {
  ...
  get whiteContainer => Align(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: Colors.white,
            borderRadius:
                BorderRadius.circular(Dimensions.radius20 * 1.4), // Adjust the radius for the desired circular shape
          ),
        ),
      );
  ...
  get meetingPlaceText => Text(
        ...
        style: TextStyle(fontFamily: FontFamilies.almarai, color: Colors.red, fontSize: Dimensions.font16 * 1.1),
      );
  ...
  get destinationText => Text(
        ...
        style: TextStyle(fontFamily: FontFamilies.almarai, color: Colors.yellow, fontSize: Dimensions.font16 * 1.1),
      );
  ...
  get stripesLine => Align(
        alignment: AlignmentDirectional.center,
        child: SizedBox(
            width: width * 0.85, height: height * 0.036, child: SvgPicture.asset(AppAssets.stripesLineBooking)),
      );
  ...
  get searchForCarButton => MyButton2(
      onTap: () {
        Navigator.push(
            context,
            PageTransition(
  ...
  get locationRedLineSvg => SizedBox(height: height * 0.09, child: SvgPicture.asset(AppAssets.lineBooking));
