...
import 'booking_screen_notes.dart';



class BookingScreenDestination2 extends StatelessWidget {
  const BookingScreenDestination2({Key? key}) : super(key: key);
