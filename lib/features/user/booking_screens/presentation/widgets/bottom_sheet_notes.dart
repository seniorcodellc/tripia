...
class _BottomSheetNotesState extends State<BottomSheetNotes> {
  ...
  get notes => Text(
        AppStrings.notes,
        style:
            TextStyle(fontFamily: FontFamilies.almarai, fontWeight: FontWeight.w700, fontSize: Dimensions.font26 / 1.1),
      );
  ...
  get cancelButton => MyButtonCancel(onTap: () {}, text: AppStrings.cancel);
