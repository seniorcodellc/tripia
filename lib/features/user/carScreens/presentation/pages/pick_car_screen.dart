...
import 'package:tripia_user/features/user/carScreens/presentation/pages/best_driver.dart';
import 'package:page_transition/page_transition.dart';
import '../../../../../core/utils/app-assets.dart';
import '../../../../../core/utils/app-color.dart';
import '../../../../../core/utils/app-string.dart';
import '../../../../../core/utils/app_fonts.dart';
import '../../../../../core/utils/widgets/dimensions.dart';
        ...
        child: Stack(
          children: [
            ...
            Column(
              children: [
                SizedBox(
                  height: context.height * 0.177,
                ),
                Row(
                  children: [
                    SizedBox(
                      width: context.width * 0.206,
                    ),
                    SvgPicture.asset(
                      AppAssets.longLineCar,
                      width: context.width * 0.684,
                    ),
                  ],
                ),
              ],
                    ...
                    Column(
                      children: [
                        ...
                        Row(
                          children: [
                            SizedBox(
                              width: context.width * 0.782,
                            ),
                            Text(
                              AppStrings.whatTheDifference,
                              style: TextStyle(
                                fontWeight: FontWeight.w400,
                                fontFamily: FontFamilies.jFlat,
